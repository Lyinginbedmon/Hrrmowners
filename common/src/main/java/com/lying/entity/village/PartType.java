...
{
	CENTER(0x0000FF, biome -> DesertVillageData.TOWN_CENTERS_KEY),
	...
	private final Function<RegistryEntry<Biome>, RegistryKey<StructurePool>> structurePool;
	
	private PartType(int col, Function<RegistryEntry<Biome>, RegistryKey<StructurePool>> poolKeyIn)
	{
		colour = col;
	...
	public RegistryKey<StructurePool> getStructurePool(RegistryEntry<Biome> biomeIn) { return structurePool.apply(biomeIn); }
